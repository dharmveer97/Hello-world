  ...
  <div className="column">
   <div className="card">
    ...
    <div className="media-content ">
        <h1 className="has-text-centered  is-size-5 is-uppercase ">Advance Technology</h1>
      </div>
    <div className="content has-text-centered has-text-weight-normal">
       All fish day af emale very appear moved seas above Fifth them grass gathere above
       male moveth whose life rule she gathering seas of is sea night
      </div>
  </div>
</div>
  </div>
