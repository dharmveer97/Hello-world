...
const Sectionstyle=styled.div`
  background-image: linear-gradient(to bottom,  rgba(76, 175, 80, 0.3), rgba(76, 175, 80, 0.3)), url("https://colorlib.com/preview/theme/supreme/img/banner_bg.png");
...
<Sectionstyle className="hero is-fullheight">
      ...
      <div className="container">
        <div className="navbar-brand">
          <a className="navbar-item">
            <img src="https://colorlib.com/preview/theme/supreme/img/logo.png" alt="Logo"
             width="112"
             height="28"/>
          </a>
        ...
        <div id="navbarMenuHeroC" className="navbar-menu">
          <div className="navbar-end">
            <a className="navbar-item is-active has-text-danger">
              HOME
            </a>
  ...
  <div className="hero-body">
    <div className="container has-text-centered">
      ...
      <h4>
        <a className="button has-text-light is-outlined is-large is-danger is-rounded">Learn More</a>
      </h4>
    </div>
  </div>
</Sectionstyle>
